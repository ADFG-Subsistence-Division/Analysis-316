---
title: "D05_MAKE_RAW_DATA_FILES - (294) Yukon Comprehensives 2024"
...
<div class="title-container">
  ...
  <div class="title">D05_MAKE_RAW_DATA_FILES - (294) Yukon Comprehensives 2024</div>
</div>
...
# %>% 
#   group_by(commname) %>% 
#   mutate(sort_key = case_when(str_detect(incsrceDesc, "Industry not specified") ~ 0,
#     TRUE ~ 1)) %>% # Assign 0 to row 2 for sorting
#   arrange(commname, sort_key) %>%
#   select(-sort_key) %>% 
#   ungroup()
...
plotMedIncData <- bind_rows(medianEmployData, acsMedIncData) %>% 
 mutate(projID = max(projID, na.rm = TRUE),
