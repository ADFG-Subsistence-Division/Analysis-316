...
If your script successfully loads REC04, but all of the records disappear, it is likely that you have failed to properly update the conversion factors for 'standardize conversion factors'.
...
unspecTable <- REC04StdData %>% filter(str_detect(resName, "Unspecified") & harvestq == 1) %>% 
  ungroup() %>% 
...
resCalcConvFactList <- list(119000000) # Unspecified resource

resGroupConvFactList <- list(c(111000000,
                               112000000,
                               113000000,
                               114000000,
                               115000000)) # Other types harvested
...
# Write out unspecified resource conversion factor table for binding to convFact.csv
  fName = str_interp('../../CSV/03 - main/REC04_calc_convFact.csv')
  cat(formatSummaryBlock(
    paste('Writing file: ', fName, 
