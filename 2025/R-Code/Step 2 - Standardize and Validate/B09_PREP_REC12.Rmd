...
unspecTable <- REC12StdData %>% filter(str_detect(resName, "Unspecified") & harvestq == 1) %>% 
  ungroup() %>% 
...
# Write out unspecified resource conversion factor table for binding to convFact.csv
  fName = str_interp('../../CSV/03 - main/REC12_calc_convFact.csv')
  cat(formatSummaryBlock(
    paste('Writing file: ', fName, 
