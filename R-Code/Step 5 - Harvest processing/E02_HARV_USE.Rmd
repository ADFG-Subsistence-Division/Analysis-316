...
# Species composition by resoure category

```{r create all species composition plots}
...
```{r large game species pie}

pwalk(
  unique(plot_combos[c("comm", "studyear")]), 
  function(comm, studyear) {
    plot_name <- paste0("large_game", "_", comm, "_", studyear, "_SpeciesPieFig")
    if (!is.null(plot_list[[plot_name]])) {
      print(plot_list[[plot_name]])
    }
  }
...
```{r small land mammals species pie}

pwalk(
  unique(plot_combos[c("comm", "studyear")]), 
  function(comm, studyear) {
    plot_name <- paste0("small_game", "_", comm, "_", studyear, "_SpeciesPieFig")
    if (!is.null(plot_list[[plot_name]])) {
      print(plot_list[[plot_name]])
    }
  }
...
```{r feral land mammals species pie}

pwalk(
  unique(plot_combos[c("comm", "studyear")]), 
  function(comm, studyear) {
    plot_name <- paste0("feral_game", "_", comm, "_", studyear, "_SpeciesPieFig")
    if (!is.null(plot_list[[plot_name]])) {
      print(plot_list[[plot_name]])
    }
  }
...
```{r marine mammals species pie}

pwalk(
  unique(plot_combos[c("comm", "studyear")]), 
  function(comm, studyear) {
    plot_name <- paste0("marine_mammals", "_", comm, "_", studyear, "_SpeciesPieFig")
    if (!is.null(plot_list[[plot_name]])) {
      print(plot_list[[plot_name]])
    }
  }
...
pwalk(
  unique(plot_combos[c("comm", "studyear")]), 
  function(comm, studyear) {
    plot_name <- paste0("birds", "_", comm, "_", studyear, "_SpeciesPieFig")
    if (!is.null(plot_list[[plot_name]])) {
      print(plot_list[[plot_name]])
    }
  }
...
```{r marine invertebrates species pie}

pwalk(
  unique(plot_combos[c("comm", "studyear")]), 
  function(comm, studyear) {
    plot_name <- paste0("marine_invert", "_", comm, "_", studyear, "_SpeciesPieFig")
    if (!is.null(plot_list[[plot_name]])) {
      print(plot_list[[plot_name]])
    }
  }
...
```{r large land mammals species pie}

pwalk(
  unique(plot_combos[c("comm", "studyear")]), 
  function(comm, studyear) {
    plot_name <- paste0("vegetation", "_", comm, "_", studyear, "_SpeciesPieFig")
    if (!is.null(plot_list[[plot_name]])) {
      print(plot_list[[plot_name]])
    }
  }
