...
unspecTable <- REC15StdData %>% filter(str_detect(resName, "Unspecified") & harvestq == 1) %>% 
  ungroup() %>% 
...
resCalcConvFactList <- list(410228990,  # Unspecified scoters
                            410299000) # Unspecified ducks

resGroupConvFactList <- list(
  c(410228020,410228040),
  c(410202000,
    410204000,
    410210990,
    410212000,
...
# Write out unspecified resource conversion factor table for binding to convFact.csv
  fName = str_interp('../../CSV/03 - main/REC15_calc_convFact.csv')
  cat(formatSummaryBlock(
    paste('Writing file: ', fName, 
