...
For Port Graham 2023, we will will split out dip net and troll gear from 'other' because these are not subsistence types for the area. Handline and 'other/unspecified' will remain as-is because only 2 total cases were recorded.
...
# Write CSIS organized non salmon fish data.
